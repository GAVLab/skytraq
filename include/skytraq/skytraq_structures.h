...
#define RESTORE_FACTORY_DEFAULTS_PAYLOAD_LENGTH 2 //!< [bytes]
#define CONFIGURE_SERIAL_PORT_PAYLOAD_LENGTH 4 //!< [bytes]
#define CONFIGURE_NMEA_INTERVALS_PAYLOAD_LENGTH 9 //!< [bytes]
#define CONFIGURE_OUTPUT_FORMAT_PAYLOAD_LENGTH 3 //!< [bytes]
#define CONFIGURE_POWER_SAVE_MODE_PAYLOAD_LENGTH 3 //!< [bytes]
